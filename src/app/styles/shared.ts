...
export const primaryButtonClass =
  "inline-flex min-h-11 items-center justify-center rounded-lg bg-site-accent px-5 py-2 font-bold text-site-on-dark shadow-sm transition-colors hover:bg-site-accent-hover";
