...
import { ModalCloseButton, NavigationArrowButton } from "./ui/ModalControls";
  ...
  return createPortal(
    ...
    >
      <div
        ...
        aria-describedby={
          showDetails && displayDescription ? "lightbox-description" : undefined
        }
            ...
            >
              ...
              {displayDescription ? (
                <div
                  ...
                  className="min-h-0 land-sm:col-start-1 land-sm:row-start-2"
                >
                  <p
                    ref={descriptionRef}
