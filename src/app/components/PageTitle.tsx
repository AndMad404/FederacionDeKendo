...
export function PageTitle({
  ...
  return (
    <h1
      id={id}
      className={`w-fit px-3 py-2 text-center text-xl font-bold uppercase leading-tight tracking-wide after:absolute after:-bottom-0.5 after:left-1/2 after:h-0.5 after:w-full after:-translate-x-1/2 ${toneClass} ${whitespaceClass} ${placementClass} ${className}`}
    >
      {children}
    </h1>
  );
