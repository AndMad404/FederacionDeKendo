...
function applyRouteHead(pathname: string) {
  ...
  document
    .querySelectorAll(
      '[data-route-seo], link[rel="canonical"], link[rel="preload"][as="image"], meta[name="author"], meta[name="description"], meta[name="robots"], meta[name^="twitter:"], meta[property^="og:"], script#route-json-ld',
    )
